      ...
      <div class="item-content">
        ...
        <div class="t314_wrap">
          <div class="t314a_status">
            <b>状态：</b>
            <span v-if="status==='1'" class="t314a_status_item" style="backgroundColor: #37a100;">上架中</span>
            <span v-if="status==='2'" class="t314a_status_item" style="backgroundColor: #649af0;">待审核</span>
            <span v-if="status==='3'" class="t314a_status_item" style="backgroundColor: #fe0002;">下架中</span>
          </div>
...
import { upShelf, downShelf } from '@/api/update.js'
export default {
  name: 'ScrutinyItem',
  props: ['item'],
  data () {

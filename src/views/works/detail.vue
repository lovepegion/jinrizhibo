			...
			<div class="detail-body">
				...
				<div class="plus0_wrap1" ref="videowrap">
					...
					<div class="plus0_1_channel">
						<!-- plus_logo -->
						<div class="plus_logo_show" v-if="choosedCompany != '合肥柯锐'">
							<img v-if="logoUrl" :src="baseUrl+logoUrl">
						</div>
						<div v-else>
							<img v-if="logoUrl" :src="baseUrl+logoUrl" style="maxWidth:120px; maxHeight:200px">
						</div>
						<div></div>
						<!-- plus_公司 -->
						<div v-if="choosedCompany != '合肥柯锐'" class="plus_company_name">
							{{choosedCompany}}
						</div>
					</div>
					<!-- plus0_1_1片头 -->
